...
class DeleteDecoration(private var context: Context, private var mDatas: List<ISuspensionInterface>?) : RecyclerView.ItemDecoration() {
    ...
    fun setmTitleHeight(mTitleHeight: Int): DeleteDecoration {
        this.mTitleHeight = mTitleHeight
        return this
    }

    fun setColorTitleBg(colorTitleBg: Int): DeleteDecoration {
        COLOR_TITLE_BG = colorTitleBg
        return this
    }

    fun setColorTitleFont(colorTitleFont: Int): DeleteDecoration {
        COLOR_TITLE_FONT = colorTitleFont
        return this
    }

    fun setTitleFontSize(mTitleFontSize: Int): DeleteDecoration {
        this.mPaint.textSize = mTitleFontSize.toFloat()
        return this
    }

    fun setmDatas(mDatas: List<ISuspensionInterface>): DeleteDecoration {
        this.mDatas = mDatas
        return this
    }

    fun setIsChoice(isChoice: Boolean): DeleteDecoration {
    ...
    fun setHeaderViewCount(headerViewCount: Int): DeleteDecoration {
